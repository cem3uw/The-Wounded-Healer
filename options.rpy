...
define config.name = _("The Wounded Healer")
define config.screen_width = 1910
...
define build.name = "The_Wounded_Healer"
...
define config.save_directory = "The_Wounded_Healer-1532654986"
